        ...
        IntersectionSrvTimingInfo* intersection_srv_timing_info)
{
    ...
    //ganton12
    intersection_srv_timing_info->intersection_start_time = reply.timing_data_in_micro().intersection_start_time();
    intersection_srv_timing_info->intersection_end_time = reply.timing_data_in_micro().intersection_end_time();    
